...
class CControlsDialog : public CAppDialog
{
   ...
   protected:
      ...
      // containers
      virtual bool      CreateMain(const long chart,
                                   const string name,
                                   const int subwin);
      
      virtual bool      CreateEditRow(const long chart,
                                      const string name,
                                      const int subwin);
      
      virtual bool      CreateButtonRow(const long chart,
                                        const string name,
                                        const int subwin);
      
      virtual bool      CreateSpinDateRow(const long chart,
                                          const string name,
                                          const int subwin);
      
      virtual bool      CreateListsRow(const long chart,
                                       const string name,
                                       const int subwin);
      
      virtual bool      CreateListsColumn1(const long chart,
                                           const string name,
                                           const int subwin);
      
      virtual bool      CreateListsColumn2(const long chart,
                                           const string name,
                                           const int subwin);
};
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CControlsDialog::CreateMain(const long chart,
                                 const string name,
                                 const int subwin)
{
   if(!m_main.Create(chart,
                     name + "main",
                     subwin,
                     0,
                     0,
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CControlsDialog::CreateEditRow(const long chart,
                                    const string name,
                                    const int subwin)
{
   if(!m_edit_row.Create(chart,
                         name + "editrow",
                         subwin,
                         0,
                         0,
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CControlsDialog::CreateButtonRow(const long chart,
                                      const string name,
                                      const int subwin)
{
   if(!m_button_row.Create(chart,
                           name + "buttonrow",
                           subwin,
                           0,
                           0,
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CControlsDialog::CreateSpinDateRow(const long chart,
                                        const string name,
                                        const int subwin)
{
   if(!m_spin_date_row.Create(chart,
                              name + "spindaterow",
                              subwin,
                              0,
                              0,
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CControlsDialog::CreateListsRow(const long chart,
                                     const string name,
                                     const int subwin)
{
   if(!m_lists_row.Create(chart,
                          name + "listsrow",
                          subwin,
                          0,
                          0,
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CControlsDialog::CreateListsColumn1(const long chart,
                                         const string name,
                                         const int subwin)
{
   if(!m_lists_column1.Create(chart,
                              name + "listscolumn1",
                              subwin,
                              0,
                              0,
...
{
   if(!m_lists_column2.Create(chart,
                              name + "listscolumn2",
                              subwin,
                              0,
                              0,
...
{
   // create
   if(!m_button2.Create(m_chart_id,
                        m_name + "Button2",
                        m_subwin,
                        0,
                        0,
...
{
   // create
   if(!m_button3.Create(m_chart_id,
                        m_name + "Button3",
                        m_subwin,
                        0,
                        0,
...
{
   // create
   if(!m_spin_edit.Create(m_chart_id,
                          m_name + "SpinEdit",
                          m_subwin,
                          0,
                          0,
...
{
   // create
   if(!m_list_view.Create(m_chart_id,
                          m_name + "ListView",
                          m_subwin,
                          0,
                          0,
...
{
   // create
   if(!m_combo_box.Create(m_chart_id,
                          m_name + "ComboBox",
                          m_subwin,
                          0,
                          0,
...
{
   // create
   if(!m_radio_group.Create(m_chart_id,
                            m_name + "RadioGroup",
                            m_subwin,
                            0,
                            0,
...
{
   // create
   if(!m_check_group.Create(m_chart_id,
                            m_name + "CheckGroup",
                            m_subwin,
                            0,
                            0,
