...
class CBox : public CWndClient
{
   ...
   protected:
      ...
      virtual bool      GetSpace(int &x_space,
                                 int &y_space);
      
      virtual bool      Render(void);
      
      virtual void      Shift(CWnd *control,
                              int &x,
                              int &y,
                              const int x_space,
                              const int y_space);
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CBox::Create(const long chart,
                  const string name,
                  const int subwin,
                  const int x1,
                  const int y1,
...
bool CBox::Render(void)
{
   ...
   int x = Left() + m_padding_left + (((m_horizontal_align == HORIZONTAL_ALIGN_LEFT) || (m_horizontal_align == HORIZONTAL_ALIGN_CENTER_NOSIDES)) ? 0 : x_space);
   
   int y = Top() + m_padding_top + (((m_vertical_align == VERTICAL_ALIGN_TOP) || (m_vertical_align == VERTICAL_ALIGN_CENTER_NOSIDES)) ? 0 : y_space);
